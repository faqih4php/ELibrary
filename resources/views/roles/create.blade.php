    ...
    <div class="p-4 mt-14 ">
        <div class="container p-6 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
            <form action="{{ route('role.store') }}" method="post">
                ...
                <div class="mb-5">
                    <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Name Role</label>
                    <div class="relative">
